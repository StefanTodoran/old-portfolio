...
export class IntroPage extends Component {
    ...
    render() {
                ...
                <View style={styles.scrollContainer}>
                    <View style={{flexDirection: "column"}}>
                        ...
                        <a href={resumePDF} target="_blank" className={"noUnderlineLink"}>
                            <div className={"menuItem"}>RESUME</div></a>
                        <View style={{flexDirection: "row", justifyContent: "center"}}>
                        ...
                        <a href={mail} target="_blank" className={"noUnderlineLink"}>
                            <div className={"menuItem"}>CONTACT</div></a>
        ...
        return(
            <View style={styles.scrollContainer}>
                <View style={{flex: 4, flexDirection: "row", justifyContent: "right"}}>
                    <div className={"iconTextBox"}>
                        <a href={resumePDF} target="_blank" className={"noUnderlineLink"} onMouseEnter={this.resumeState} onMouseLeave={this.resumeState}>
                            <div className={"menuItem"}>RESUME</div></a>
                        <View style={{flexDirection: "row", justifyContent: "center"}}>
                        <svg width="50" height="52" viewBox="0 0 50 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="50" height="52"/>
                    ...
                    <div className={"iconTextBox"}>
                        <a href={mail} target="_blank" className={"noUnderlineLink"} onMouseEnter={this.contactState} onMouseLeave={this.contactState}>
                            <div className={"menuItem"}>CONTACT</div></a>
                        <View style={{flexDirection: "row", justifyContent: "center"}}>
                        <svg width="57" height="49" viewBox="0 0 41 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="Untitled (1) 1">
